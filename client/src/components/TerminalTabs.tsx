                    ...
                    if (index === 0) {
                        return (
                            <Terminal
                                ...
                                readonly={readonly}
                                onTerminalReady={(terminal) => terminalStore.attachBoltTerminal(terminal)}
                                onTerminalResize={(cols, rows) => terminalStore.onTerminalResize(cols, rows)}
                            />
                        );
                    } else {
                        return (
                            <Terminal
                                ...
                                readonly={readonly}
                                onTerminalReady={(terminal) => terminalStore.attachTerminal(terminal)}
                                onTerminalResize={(cols, rows) => terminalStore.onTerminalResize(cols, rows)}
                            />
                        );
                    }
